...
(function (halyk) {
    ...
    function addCssClass() {
        ...
        style.type = "text/css";
        var styleClasses = ".widgetScreen {position: absolute; width: 100vw; height: 200%; top: 0; bottom: 0; left: 0; right: 0; z-index: 1000; background-color: rgba(5, 5, 5, 0.5); display: flex; justify-content: center; align-items: center;}";
        styleClasses += ".iframeBox{border-radius: 4px; position: absolute; width: 420px; height: 100vh; z-index: 1010; background-color: #fff; padding: 10px; -ms-overflow-style: none; scrollbar-width: none;}";
