"""
Django settings for Tatexkz project.
...
SECRET_KEY = 'django-insecure-!amdrn@uz=4&9io$sz&lh867)&hmxk4v19u$(dx8^_@qrhtxva'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["192.168.1.107", "127.0.0.1", '185.125.88.124']
...
ROOT_URLCONF = 'Tatexkz.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            BASE_DIR.joinpath("Tatexkz").joinpath("templates")
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Tatexkz.wsgi.application'
